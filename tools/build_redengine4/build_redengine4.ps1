# uevr REDengine 4 Adapter Build Script
# Builds Cyberpunk 2077 VR adapter with full cross-engine integration
...
$ScriptName = "build_redengine4.ps1"
$ProjectName = "uevr REDengine 4 Adapter"
$SourceDir = "../../adapters/REDengine4"
$BuildDir = "build"
$LogsDir = "../../logs/build/redengine4"
$CMakeFlags = "/W4"
...
try {
    ...
    Write-Log "Deploying to Cyberpunk 2077 profile..."
    $profileDir = "../../profiles/Cyberpunk2077"
    $dllPath = "redengine4_adapter.dll"
