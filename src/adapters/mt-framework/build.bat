...
echo ========================================
echo MT-Framework Cross-Engine VR Adapter Build
echo ========================================
...
echo Building MT-Framework Cross-Engine VR Adapter...
...
echo [2/3] Building MT-Framework Adapter...
...
echo.
echo ========================================
echo MT-Framework Adapter Build Complete!
echo ========================================
pause
